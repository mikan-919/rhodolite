...
This capability SHALL leave optional operations, arrays, method calls, and associated-function calls outside its inference boundary. The checker SHALL treat this as a temporary implementation limitation rather than as a language-level wildcard or dynamic type.

#### Scenario: Unsupported expression reaches a compatibility check
- **WHEN** an optional operation, array expression, method call, or associated-function call reaches a check added by this capability
