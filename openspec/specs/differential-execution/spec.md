...
`with` provisions, provider substitution, and the canonical production
program. Each corpus member SHALL identify the entry point and any observable
final state required for comparison.
